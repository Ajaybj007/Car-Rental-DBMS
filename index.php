		...
		<div class="wrapper">
			...
			?>
				...
				<li>
					...
					<a href="book_car.php?id=<?php echo $rws['car_id'] ?> && avail=<?php echo $ava?>">
						<img class="thumb" src="cars/<?php echo $rws['image'];?>" width="300" height="200">
					</a>
					<span class="price"><?php echo 'Rs.'.$rws['hire_cost'];?></span>
					<div class="property_details">
						<h1>
							<a href="book_car.php?id=<?php echo $rws['car_id'] ?> && avail=<?php echo $rws['availability']?><?php echo 'Car Make>'.$rws['car_type'];?></a>
						</h1>
			...
			<ul>
				<li class="links">
					<ul>
						...
						<li><a href="mailto:sujayks007@gmail.com">Contact Us</a></li>
					</ul>
				</li>
